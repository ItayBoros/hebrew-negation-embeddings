...
\author{Itay Boros (ID.\ TODO), Shachar Ben Zur (ID.\ TODO)}
...
guideline document (kappa value: TODO --- insert once both annotation
files are complete).
...
pairs). \textbf{Decontamination.} All three HebNLI splits used for
...
with inherited English gold scores, not natively annotated. No $\gamma$ in
our search grid resolves \texttt{multilingual-e5}'s collapse guard.
